...
#Executes the build_layer_docker.sh script. This script is responsible for creating a Lambda layer,
#typically containing Python dependencies like Pillow for image processing, packaged within a Docker container to ensure consistent build
