...
#This is a utility tool that runs locally on your machine during terraform plan/apply.
#It takes your single lambda_function.py file and zips it up on the fly.
#It saves you from having to manually zip your code before running Terraform.
#Crucial Part: It calculates a output_base64sha256 hash. If you change a character in your Python script, the hash changes, and Terraform knows it needs to "re-deploy" the function.
...
resource "aws_lambda_function" "image_processor" {
  ...
  environment {
    # (Optional) Map of environment variables available to your Lambda function during execution.
    variables = {
