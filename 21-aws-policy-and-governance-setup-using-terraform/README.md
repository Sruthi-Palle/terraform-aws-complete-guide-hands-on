...
```
21-aws-policy-and-governance-setup-using-terraform/
...
- Its better to attach "s3:DeleteObject" policy at bucket level to ensure only the users with MFA access can delete the object. If you add the policy at user level, you have to always attach the policy to the new user.
