...
**Official Installation Guide:** HashiCorp Install Instructions
...
**Good Practice:** Emphasise the principle of least privilege for IAM users/roles. Avoid using root credentials.

**Install AWS CLI:** Follow official AWS documentation
