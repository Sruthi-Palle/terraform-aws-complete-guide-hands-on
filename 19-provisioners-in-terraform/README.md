...
- Don't Use provisioners when native Terraform resources exist
- Don't Rely on provisioners for critical configuration
- Don't Forget that provisioners only run on creation
- Don't Store sensitive data in provisioner commands
- Don't Use complex logic - move to proper config management tools
